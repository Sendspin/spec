...
- `source@v1_support?`: object - server-side parameters for clients with the `source@v1` role ([see server-side source@v1 support object details](roles/source/v1.md#server--client-serverhello-sourcev1-support-object))
